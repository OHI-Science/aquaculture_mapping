...
write.csv(tonnes_per_farm, "marine/marine_fish_general/finfish_farms/output/finfish_comp_tonnes_per_farm.csv", row.names = FALSE)
...
med_global_marine_fish_general_tonnes_per_farm = median(tonnes_per_farm$tonnes_per_farm)
med_global_marine_fish_general_tonnes_per_farm # 172.4093
```
