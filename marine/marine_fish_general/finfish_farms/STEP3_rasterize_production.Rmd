...
farms <- read.csv(here::here("marine/marine_fish_general/finfish_farms/data/global_finfish_farm_lat_lon.csv"))
...
fao <- read.csv(here::here("marine/marine_fish_general/finfish_farms/data/fao_mariculture_finfish.csv")) %>%
...
st_write(farms_sf_prod, "marine/marine_fish_general/finfish_nutrient/prod_data_by_cell_iso3c.shp")
```
