...
## write to farms folder 
write_csv(farms_phl_final, here("marine/marine_fish_general/finfish_farms/data/finfish_sites/farms_phl.csv"))
```
...
write.csv(all_farms, here::here("marine/marine_fish_general/finfish_farms/data/global_finfish_farm_lat_lon.csv"), row.names = FALSE)
