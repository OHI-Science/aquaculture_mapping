...
cellStats(salmon_raster, stat = "sum") # 2756155
sum(salmon_raster_df$tonnes_production) # 2756155
sum(farms_sf$tonnes_per_farm, na.rm = TRUE) # 2756155
...
writeRaster(salmon_raster, "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/aquaculture/marine/production/rasters/salmon_production_rast.tif")
```
