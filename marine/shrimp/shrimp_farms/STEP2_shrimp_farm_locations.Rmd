...
# mapview(philly2)
#   
# linestring_fix <- st_difference(buffer_outline_fixed, philly) ## now grab only the outline 
# mapview(linestring_fix)
...
philly_points_lines <- sample.line(philly_crop, n = 2) ## equally place the number of farms along the coastline 
