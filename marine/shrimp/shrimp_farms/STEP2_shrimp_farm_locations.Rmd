...
# 
# ## write to farms folder 
# write_csv(farms_irn_final, here("marine/shrimp/shrimp_farms/data/farm_sites/farms_irn.csv"))
...
write.csv(all_farms, here::here("marine/shrimp/shrimp_farms/data/global_shrimp_farm_lat_lon.csv"), row.names = FALSE)
