...
farms <- read.csv(here::here("marine/tuna/tuna_farms/data/global_tuna_farm_lat_lon.csv"))
...
st_write(farms_sf_prod, "marine/tuna/tuna_nutrient/prod_data_by_cell_iso3c.shp")
