...
production <- read_csv(file.path(path_prep, "tuna_farm.csv"))
food_raster <- raster(nrows=2160, ncols=4320, xmn=-180, xmx=180, ymn=-90, ymx=90)
```

What I've found (we ended up only using global values): 
...
3. We report in PO4eq: Multiply P by by 3.07 to get PO4eq and N by 0.42 to get PO4eq. Sum the N and P PO4eq rasters.
