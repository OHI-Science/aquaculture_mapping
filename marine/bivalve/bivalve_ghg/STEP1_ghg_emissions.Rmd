...
bivalve_production <- read_csv(file.path("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/aquaculture/marine/bivalve/bivalve_farm.csv"))

fao_bivalve_spp <- read_csv(here("aquaculture/marine/bivalve/bivalve_farms/data/fao_mariculture_bivalve_taxa_production.csv"))
...
cellStats(bivalve_production_raster, "sum") # 17435623

ghg_em <- bivalve_production_raster*GHG_MTCO2e_tfish
plot(log(ghg_em + 1))
cellStats(ghg_em, "sum") # 18100668
ghg_em

#check
17435623*GHG_MTCO2e_tfish #18100667 - close enough
# it worked
...
cellStats(ghg_em_final, "sum") #18100668
ghg_em_final
