...
Based on the two datasets below, we have an existing 1010 bivalve farms. We need to add 193 points to existing 1010 (a final total of 1203 points)
...
us_ct_bivalve_mol <- st_transform(spdf, crs = "+init=epsg:3035") # convert to equal area projection to find centroids. 
...
us_al_bivalve_mol <- st_transform(spdf, crs = "+init=epsg:3035") # convert to equal area projealion to find centroids. 
...
## US Northeast - NY, CT, ME, NH
 ...
 Only used this for exploration
