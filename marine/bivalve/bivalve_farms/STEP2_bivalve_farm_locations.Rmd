...
Good qualifications: Locations are projected or it is a only sample of total locations (NASO maps) 
...
Bad qualifications: No data at all (randomly placed point(s) along the coast, a non-specific number), google maps estimates. 
