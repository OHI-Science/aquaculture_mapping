...
sum(fao_bivalve_taxa_prod$fao_tonnes_production) # 17435623
unique(fao_bivalve_taxa_prod$country) # 42 countries
  
## When doing the filter for >500 tonnes by taxa group: 
# sum(fao_bivalve_taxa_prod$value) # 17446096
# unique(fao_bivalve_taxa_prod$country) # 43 countries - senegal added

write.csv(fao_bivalve_taxa_prod, here("marine/bivalve/bivalve_farms/data/fao_mariculture_bivalve_taxa_production.csv"), row.names=FALSE)
...
write.csv(fao_bivalve, here("marine/bivalve/bivalve_farms/data/fao_mariculture_bivalve.csv"), row.names=FALSE)
        
 explore <- read_csv(here("marine/bivalve/bivalve_farms/data/fao_mariculture_bivalve.csv")) %>%
   filter(year==2017) %>%
