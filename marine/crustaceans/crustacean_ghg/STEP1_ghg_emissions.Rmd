...
crustacean_production <- read_csv(file.path("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/aquaculture/marine/crustaceans/crustaceans_farm.csv"))

fao_crustacean_spp <- read_csv(here("aquaculture/marine/crustaceans/crustacean_farms/data/fao_mariculture_crustaceans_taxa_production.csv"))
...
ghg_energy_kgCO2_kg_fish <- ghg_kgCO2_kg_fish # *1 ##   0.381375 kg CO2eq/ kg fish (live/carcass weight, ratioed)
...
sum(crustacean_ghg$crustacean_ghg_tonnes) # 1383721
...
cellStats(crustacean_production_raster, "sum") # 401719.1

ghg_em <- crustacean_production_raster*GHG_MTCO2e_tfish
plot(log(ghg_em + 1))
cellStats(ghg_em, "sum") # 1383721
ghg_em

#check
401719.1*GHG_MTCO2e_tfish # 1383721
# it worked
...
cellStats(ghg_em_final, "sum") # 1383721
ghg_em_final
