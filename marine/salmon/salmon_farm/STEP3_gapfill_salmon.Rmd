...
number_files <- list.files(here("marine/salmon/salmon_farm/data/known_number_farms_3"), full=TRUE)
all_number_3 = plyr::ldply(number_files, read_csv)

subset_farms_files <- list.files(here("marine/salmon/salmon_farm/data/subset_known_add_points_4"), full=TRUE)
subset_add_4 = plyr::ldply(subset_farms_files, read_csv)

no_info_files <- list.files(here("marine/salmon/salmon_farm/data/no_info_1"), full=TRUE)
...
avg_global_salmon_tonnes_per_farm # 930.3976
```
