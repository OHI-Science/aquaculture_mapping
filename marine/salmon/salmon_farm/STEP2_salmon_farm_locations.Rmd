...
Fair qualifications: A specific number of farms are placed on the coast, without knowing exact locations. 

Bad qualifications: Per province/state locations (i.e. placing a point randomly in each provice), no data at all (randomly placed point(s) along the coast, a non-specific number), google maps estimates. 
...
write_csv(farms_chile, here("marine/salmon/salmon_farm/data/farm_sites/farms_chile.csv"))
...
write_csv(farms_nor, here("marine/salmon/salmon_farm/data/farm_sites/farms_nor.csv"))
...
write_csv(farms_scotland, here("marine/salmon/salmon_farm/data/farm_sites/farms_scotland.csv"))
...
write_csv(farms_all_fro, here("marine/salmon/salmon_farm/data/farm_sites/farms_fro.csv"))
...
write_csv(farms_tas, here("marine/salmon/salmon_farm/data/farm_sites/farms_tas.csv"))
...
write_csv(farms_bc, here("marine/salmon/salmon_farm/data/farm_sites/farms_bc_can.csv"))
...
write_csv(farms_nb, here("marine/salmon/salmon_farm/data/farm_sites/farms_nb_can.csv"))
...
write_csv(farms_ns, here("marine/salmon/salmon_farm/data/farm_sites/farms_ns_can.csv"))
...
write_csv(farms_new_lab, here("marine/salmon/salmon_farm/data/farm_sites/farms_new_lab_can.csv"))
...
Our Sound, Our Salmon, 2017. [Accessed January 31, 2020] http://www.moldychum.com/violations-prompt-washington-state-cancel-atlantic-salmon-farm-lease/
 ...
 - this will receive a 0.667 (good quality), since I do not believe it is comprehensive, and is only a sample of points. 
...
write_csv(farms_ps, here("marine/salmon/salmon_farm/data/farm_sites/farms_ps_usa.csv"))

```

## US Northeast
Source:
Northeast Regional Ocean Council, 2018. Northeast ocean data: aquaculture. [Accessed January 17, 2020] https://www.northeastoceandata.org/data-download/
...
write_csv(farms_us_ne, here("marine/salmon/salmon_farm/data/farm_sites/farms_ne_usa.csv"))
...
write_csv(farms_all_nzl, here("marine/salmon/salmon_farm/data/farm_sites/farms_nz.csv"))
...
write_csv(farms_ire, here("marine/salmon/salmon_farm/data/farm_sites/farms_ire.csv"))
...
write_csv(farms_russia, here("marine/salmon/salmon_farm/data/farm_sites/farms_russia.csv"))
...
write_csv(farms_all_JPN, here("marine/salmon/salmon_farm/data/farm_sites/farms_japan.csv"))
...
write.csv(farms_dk, here("marine/salmon/salmon_farm/data/farm_sites/farms_denmark.csv"), row.names = FALSE)
...
Source: 
Candan, A., Karatas, S., Kücüktas, H., Okumus, I. (Eds.), 2007. Marine aquaculture in Turkey. Türk Denzi Araştırmaları Vakfı, İstanbul.
...
write_csv(farms_turkey, here("marine/salmon/salmon_farm/data/farm_sites/farms_tur.csv"))
...
write.csv(farms_fi, here("marine/salmon/salmon_farm/data/farm_sites/farms_finland.csv"), row.names = FALSE)

farms_fi <- read_csv(here("marine/salmon/salmon_farm/data/farm_sites/farms_finland.csv"))
```
...
write.csv(farms_sw, here("marine/salmon/salmon_farm/data/farm_sites/farms_sweden.csv"), row.names = FALSE)

#farms_sw <- read_csv(here("marine/salmon/salmon_farm/data/farm_sites/farms_sweden.csv"))
```
...
write_csv(farms_all_ISL, here("marine/salmon/salmon_farm/data/farm_sites/farms_isl.csv"))
...
farm_files <- list.files(here("marine/salmon/salmon_farm/data/farm_sites"), full=TRUE)
