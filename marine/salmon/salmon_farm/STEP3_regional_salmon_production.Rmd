...
write.csv(norway_mar_gf, here("marine/salmon/salmon_farm/data/norway_mariculture_gf.csv"), row.names=FALSE ) 
...
production <- read.csv(here("marine/salmon/salmon_farm/data/norway_mariculture_gf.csv")) %>%
...
write_csv(all_prod, here("marine/salmon/salmon_farm/data/proportional_regional_production.csv"))

# all_prod <-  read_csv(here("marine/salmon/salmon_farm/data/proportional_regional_production.csv"))
```
