...
production <- read_csv(file.path(path_prep, "marine_fish_general_farm.csv"))
...
production_sf <- st_read(file.path("/home/sgclawson/github/food_systems/aquaculture/marine/marine_fish_general/finfish_nutrient/prod_data_by_cell_iso3c.shp")) %>%
...
sum(nutrient_data$total_N_P_t) # 507965.9
...
cellStats(finfish_raster_check, stat = "sum", na.rm = TRUE) # 507965.9
...
cellStats(finfish_raster, stat = "sum") # 507965.9
sum(finfish_raster_df$N_P_tonnes) # 507965.9
sum(nutrient_data$total_N_P_t, na.rm = TRUE) # 507965.9
...
plot(log(finfish_raster_check+1))
cellStats(finfish_raster_check, stat = "sum", na.rm = TRUE) # 435852.5
...
cellStats(finfish_raster, stat = "sum") # 435852.5
sum(finfish_raster_df$N_tonnes) # 435852.5
sum(nutrient_data$N_poll_t, na.rm = TRUE) # 435852.5
...
plot(final_rast)
final_rast
cellStats(final_rast, "sum") # 435852.5
...
plot(log(finfish_raster_check+1))
cellStats(finfish_raster_check, stat = "sum", na.rm = TRUE) # 72113.4
...
cellStats(finfish_raster, stat = "sum") # 72113.4
sum(finfish_raster_df$P_tonnes) # 72113.4
sum(nutrient_data$P_poll_t, na.rm = TRUE) # 72113.4
...
plot(final_rast)
final_rast
cellStats(final_rast, "sum") # 72113.4
