...
salmon_conversion <- read_csv(here("marine/salmon/food_pressures/salmon_disturbance/data/salmon_conversion_factors.csv"))
...
```{r}
production_raster <- rasterFromXYZ(read_csv(paste0(path_prep, "salmon_farm.csv")), crs = food_crs) 

#plot(production_raster)
cellStats(production_raster, stat = "sum") # 2746086
...
crs(final_rast)
plot(final_rast)
cellStats(final_rast, "sum") # 70.82137
final_rast
