...
salmon_production <- read_csv(file.path("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/aquaculture/marine/salmon/salmon_farm.csv"))
...
species_list <- read.csv(here("marine/species_groups/int/marine_groups.csv"))  %>%
...
sum(salmon_production_ghg$ghg_tonnes) # 2608782
...
cellStats(salmon_production_raster, "sum") # 2746086

ghg_em <- salmon_production_raster*GHG_MTCO2e_tfish
plot(log(ghg_em + 1))
cellStats(ghg_em, "sum") # 2608782
ghg_em
...
#check
2746086*GHG_MTCO2e_tfish #2608782
# it worked
...
cellStats(ghg_em_final, "sum") # 2608782
ghg_em_final
