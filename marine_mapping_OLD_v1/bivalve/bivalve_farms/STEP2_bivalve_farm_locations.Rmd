...
We filter out france and great britain, because those farms are already accounted for in the EMODnet database. 
...
write_csv(farms_chile, here("marine/bivalve/bivalve_farms/data/bivalve_sites/farms_chl.csv"))
...
write_csv(farms_eu_final, here("marine/bivalve/bivalve_farms/data/bivalve_sites/farms_GBR_FRA_IRL_BGR_NOR_NLD_ITA_GRC.csv"))
...
## Taiwan
- I can't find any information on the locations of shellfish farms in Taiwan. I will randomly place a point in the Qigu lagoon (see article). 
