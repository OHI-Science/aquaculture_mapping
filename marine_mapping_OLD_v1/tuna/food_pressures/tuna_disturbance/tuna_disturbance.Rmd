...
Assumptions: **make sure to both cite in the SI methods, already in Zotero**
...
```{r}
production_raster <- rasterFromXYZ(read_csv(paste0(path_prep, "tuna_farm.csv")), crs = food_crs) 
...
crs(final_rast)
plot(final_rast)
cellStats(final_rast, "sum") # 1.55232
final_rast
