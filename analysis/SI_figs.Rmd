...
ggsave(sprintf("analysis/si_figs/supp_map_fig_%s.jpg", spp_group), units = "in", width = 8.07, height = 5.34)
}
...
ggsave(sprintf("analysis/si_figs/supp_map_fig_%s.jpg", data_type_2_id), units = "in", width = 8.07, height = 5.34)
...
ggsave("analysis/si_figs/workflow_fig_1.jpg", units = "in", width = 8.07, height = 5.34)
...
ggsave("analysis/si_figs/workflow_fig_2.jpg", units = "in", width = 8.07, height = 5.34)
