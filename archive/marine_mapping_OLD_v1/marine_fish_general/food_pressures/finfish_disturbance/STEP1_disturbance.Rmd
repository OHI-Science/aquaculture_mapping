...
```{r}
production_raster <- rasterFromXYZ(read_csv(paste0(path_prep, "marine_fish_general_farm.csv")), crs = food_crs) 

#plot(production_raster)
cellStats(production_raster, stat = "sum") # 3901214
...
crs(final_rast)
plot(final_rast)
cellStats(final_rast, "sum") # 49.87762
final_rast
...
cellStats(final_rast, "sum") # 66.1818
final_rast
